    ...
    <section className="rounded-lg border border-neutral-200 bg-white p-5">
      ...
      <div className="grid gap-3">
        <input
          ...
          className="min-h-10 rounded-md border border-neutral-300 px-3 text-sm outline-none focus:border-neutral-950"
        />
        <input
          value={query}
        ...
        <textarea
          ...
          className="min-h-72 rounded-md border border-neutral-300 p-3 text-sm outline-none focus:border-neutral-950"
        />
      </div>
